...
import {StatusDot, AvatarContainer} from '@/styles/common.ts'
...
export const ChannelMenuButton = styled.button`
  background: none;
  border: none;
  ...
  ${StyledChannelItem}:hover &,
  ${PrivateChannelWrapper}:hover & {
    opacity: 1;
  }
`

export const ChannelMenuDropdown = styled.div`
  position: absolute;
  top: 100%;
  right: 0;
